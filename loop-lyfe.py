...
with col3:
    st.image("https://i.ibb.co/pBvrYgwV/dare-dungeon.png")
...
with st.expander("💡 What is Dare Dungeon?"):
    st.write("Dare Dungeon is a fun, interactive web app designed to challenge users with spontaneous, light-hearted dares.")
